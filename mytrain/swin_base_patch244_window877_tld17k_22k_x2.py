...
ann_file_train = f'/caok15/Video-Swin-Transformer/data/tld17k/tld17k_train_list_videos.txt'
ann_file_val = f'/caok15/Video-Swin-Transformer/data/tld17k/tld17k_val_list_videos.txt'
ann_file_test = f'/caok15/Video-Swin-Transformer/data/tld17k/tld17k_val_list_videos.txt'
img_norm_cfg = dict(
...
# optimizer
optimizer = dict(type='AdamW', lr=2e-3, betas=(0.9, 0.999), weight_decay=0.05,
...
work_dir = '/caok15/Video-Swin-Transformer/mytrain/work_dirs/tld17k_swin_base_22k_patch244_window877'
