...
def parse_args():
    ...
    parser.add_argument('--config',
                        default='/caok15/Video-Swin-Transformer/mytrain/swin_base_patch244_window877_tld17k_22k.py',
                        help='test config file path')
    parser.add_argument('--checkpoint',
                        default='/caok15/Video-Swin-Transformer/mytrain/work_dirs/ucf101_swin_base_22k_patch244_window877.py/epoch_30.pth',
                        help='checkpoint file')
    parser.add_argument(
        '--out',
        default='/caok15/Video-Swin-Transformer/mytrain/ucf101_test_result.pkl',
